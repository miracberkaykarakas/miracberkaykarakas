...
**Siber güvenlik** ve **yazılım** alanında kendimi geliştiriyorum. Eğitim projeleri ve araçlar üzerine çalışıyorum.
...
- Python ve Node.js ile araçlar ve uygulamalar geliştiriyorum
...
`Web güvenliği` `SSL/TLS` `HTTP headers` `Penetration testing` `Ağ analizi`

### İlgilendiğim alanlar
`Siber güvenlik` `Web güvenliği` `Python` `Node.js` `Ağ güvenliği` `Araç geliştirme` `Backend` `API`
...
![GitHub stats](https://github-readme-stats.vercel.app/api?username=miracberkaykarakas&show_icons=true&theme=default&hide_border=true)
...
[![GitHub](https://img.shields.io/badge/GitHub-Profil-181717?style=for-the-badge&logo=github)](https://github.com/miracberkaykarakas)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/miracberkaykarakas)
